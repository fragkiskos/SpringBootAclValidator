...
import acldemo.validation.request.parameterInfoExtraction.requestResponseMocking.MockedHttpResponse;
import acldemo.validation.request.parameterInfoExtraction.validatedClasses.ResponseBodyValidationClass;
import acldemo.validation.request.parameterInfoExtraction.validatedClasses.ResponseEntityValidationClass;
...
public class ResponseEntityValidationTest {
    ...
    private HandlerMethod getHandlerMethod(String methodName, Class parameterType) throws ClassNotFoundException, NoSuchMethodException {
        Class myClass = Class.forName(ResponseEntityValidationClass.class.getName());
